    ...
    return (
        <div className={classes.product}>
            <div className={classes.image}>
                { product.images && <Image src={product.images[0].src}  alt={product.id}  layout="fill"/> }
            </div>
            <div className={classes.content}>
                <div className={classes.title}>
                    <h2 className={classes.category}>{ !product.categories ? "SIN CATEGORIA" : product.categories[0].name }</h2>
